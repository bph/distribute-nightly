...
Runs unattended via GitHub Actions ([nightly.yml](.github/workflows/nightly.yml)), daily at 07:00 UTC (09:00 CEST / 08:00 CET):
...
Each run posts ✅/❌ to the build-log issue [bph/gutenberg#204](https://github.com/bph/gutenberg/issues/204).
...
- **Runbook:** pipeline walkthrough + troubleshooting in [documentation/RUNBOOK.md](documentation/RUNBOOK.md)
