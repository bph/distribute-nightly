...
- **Stage 2 — go live:** Enable schedule (07:00 UTC), watch a week of green runs, then decommission the Mac routine. Verify the next real version jump (23.7 → 23.8, when v23.7.0-rc ships ~late Aug) via the jump log line + new `23.8-nightly` release.
